...
const Footer: React.FC<IFooter> = ({ className, ...footerProps }) => {
  return (
    <footer
      {...footerProps}
      className={`w-full p-5 bg-gray-800 text-slate-500 ${className}`}
    >
      <div className="text-center text-sm lg:text-base container xl:max-w-7xl mx-auto px-4 py-12 lg:px-8 lg:py-16">
        <div className="space-y-5">
          ...
          <nav className="space-x-2 sm:space-x-4">
            <a href="" className="font-medium text-white hover:opacity-75">
              Terms of Service
            </a>
            <a href="" className="font-medium text-white hover:opacity-75">
              Privacy Policy
          ...
          <nav className="space-x-4">
            <a
              href="https://twitter.com/Etoilistes_De?s=20&t=RWbLye8_XTznv1EKChb71g"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://www.facebook.com/EtoilistesinDeutschland"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://www.instagram.com/etoilistes_in_deutschland_e.v/?igshid=YmMyMTA2M2Y%3D"
              target="_blank"
              rel="noreferrer"
              className="text-red-400 hover:text-red-700"
            >
            ...
            {/* <a href="" className="text-red-400 hover:text-red-700">
              <svg
                fill="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="text-red-500">
          <span className="text-2xl font-bebas">
            ETOILISTES IN DEUTSCHLAND © 2022
          </span>
        </div>
      </div>
    </footer>
